...
// Solution of the Date provided by Moshi Library
...
interface CivicsApiService {
    ...
    // Ex. https://www.googleapis.com/civicinfo/v2/elections?..
    @GET("/elections")
    ...
    @GET("/representatives")
    suspend fun getRepresentatives(@Query("address") address: String): Representative
}
